...
### Criando o schema `laraveldb`

Para provisionar o ambiente usado pela aplicação Laravel (usando as credenciais de `.env.example`):
...
#### Visualizando o schema no DataGrip
